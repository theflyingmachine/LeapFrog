...
import com.ericabraham.leapfrog.Adapter.ReminderListAdapter;
import com.ericabraham.leapfrog.Database.locationDatabase;
import com.ericabraham.leapfrog.Interface.RefreshReminderList;
...
public class MainActivity extends AppCompatActivity implements
  ...
  private void displayData() {
    ...
    id = db.displayId();
    ReminderListAdapter adapter = new ReminderListAdapter(this, id, task, pname, date, address);
  ...
  @Override public void onRefreshReminderList() {
  ...
  public static class NotificationMgr extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      Toast.makeText(context, "Task marked is Opening Map ", Toast.LENGTH_SHORT).show();
  ...
  public static class SkipTask extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      db.updateSkipList(id);
      Toast.makeText(context, "Task marked is Skiped ", Toast.LENGTH_SHORT).show();
      //This is used to close the notification tray
      Intent it = new Intent(Intent.ACTION_CLOSE_SYSTEM_DIALOGS);
      context.sendBroadcast(it);
      NotificationManager notificationManager =
